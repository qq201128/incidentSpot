...
SCHEMA_MIGRATIONS = (
  ...
  "ALTER TABLE predictions ADD COLUMN execution_status TEXT NOT NULL DEFAULT 'generated'",
  "ALTER TABLE predictions ADD COLUMN execution_reason TEXT",
  "ALTER TABLE predictions ADD COLUMN execution_checked_at TEXT",
  "ALTER TABLE predictions ADD COLUMN execution_event_id INTEGER",
  "ALTER TABLE events ADD COLUMN prediction_id INTEGER",
  ...
  "CREATE INDEX IF NOT EXISTS idx_paper_live_failures_strategy_recent ON paper_live_prediction_failures(strategy_key, symbol, duration, id DESC)",
