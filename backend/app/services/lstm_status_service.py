...
from app.services.lstm_candidate_progress import read_lstm_candidate_progress
...
def lstm_model_status(symbol: str, duration: str, *, artifact_root: Path | None = None) -> dict[str, Any]:
    ...
    return {
        **status,
        ...
        "candidateSearchProgress": read_lstm_candidate_progress(sym, duration, artifact_root=artifact_root),
