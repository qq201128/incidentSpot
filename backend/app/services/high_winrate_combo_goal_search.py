    ...
    for size in COMBO_SIZES:
        for members in combinations(names, size):
            ...
            train_best = best_threshold_hit_with_diagnostics(
                ...
                orientations,
                train_score,
                score_index=train_threshold_frame.index,
                frame=train_threshold_frame,
            ...
            validation_hit, rejected = threshold_hit_result(
                ...
                orientations,
                validation_score,
                score_index=validation_threshold_frame.index,
                frame=validation_threshold_frame,
